...
export default function FlutterAssignmentsPage() {
  ...
  const items = t('assignmentsPage.items', { returnObjects: true }) as AssignmentItem[]
      ...
      <section className={styles.assignmentsSection}>
        <div className="container">
          ...
          <div className={styles.assignmentHeader}>
            <a className={styles.blogLink} href={t('assignmentsPage.blogUrl')} target="_blank" rel="noreferrer">
              {t('assignmentsPage.blogLabel')}
            </a>
          </div>
              ...
              <article key={item.src} className={styles.assignmentCard}>
                <div className={styles.assignmentImage} onClick={() => openLightbox(idx)}>
                  ...
                  <div className={styles.imageOverlay}>
                    <span>{t('assignmentsPage.heading')}</span>
                  </div>
                </div>
