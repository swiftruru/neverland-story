...
export default function FlutterFeaturesPage() {
  ...
  const getLink = (id: string, slot: 'link1' | 'link2' | 'link3') => {
    const links: Record<string, Record<string, string>> = {
      ...
      practice: {
        link1: 'https://medium.com/@apppeterpan/精心設計的課堂練習和課後作業-b2ff1199e70c',
        link2: 'https://medium.com/@apppeterpan/參考模仿學長姐的-ios-app-作業-感謝同學們精心繪製的圖片-e71f920aeb1e',
      },
      blog: { link1: 'https://medium.com/@apppeterpan/ios-app-開發作家養成計畫-f6eea56c5f4d' },
      consult: {
        link1: 'https://bit.ly/2FHfNic',
        link2: 'https://medium.com/彼得潘的-swift-ios-app-開發教室/neverland-課程結束後陪你繼續寫-ios-app-47562dd5ac49',
      },
      workshop: {
